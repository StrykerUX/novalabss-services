  ...
  return (
    <div className="p-8 flex flex-col items-center justify-center min-h-[500px]">
      ...
      <div className="text-center mb-12">
        <div className="bg-gray-900/50 rounded-2xl p-8 max-w-2xl border border-gray-800">
          ...
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-gray-400 text-sm">Resultado verificado</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-gray-500 text-sm">
          🎯 Preparando tu propuesta final... <span className="text-blue-400">({timeLeft}s)</span>
        </p>
      </div>
    </div>
  )
