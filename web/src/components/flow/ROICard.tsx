  ...
  const flowData = useMemo(() => {
    const combinations = {
      ...
      "pocos_encuentran_2-3_clientes": {
        ...
        caseResult: "4 clientes/mes en 3 días",
        caseGain: "$12,000",
        userGain: "$7,500",
      ...
      "pocos_encuentran_5-10_clientes": {
        ...
        caseResult: "11 clientes/mes en 5 días",
        caseGain: "$27,500",
        userGain: "$20,000",
        plan: "rocket" as const,
        planPrice: "$999",
      ...
      "pocos_encuentran_10-20_clientes": {
        ...
        caseResult: "18 clientes/mes en 3 días", 
        caseGain: "$54,000",
        userGain: "$45,000",
      ...
      "pocos_encuentran_20_plus_clientes": {
        ...
        caseResult: "32 clientes/mes en 5 días",
        caseGain: "$96,000", 
        userGain: "$75,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "no_confianza_2-3_clientes": {
        ...
        caseGoal: "3 clientes más/mes",
        caseResult: "5 clientes/mes en 5 días",
        caseGain: "$15,000",
        userGain: "$7,500", 
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "no_confianza_10-20_clientes": {
        ...
        caseGoal: "15 clientes más/mes",
        caseResult: "21 clientes/mes en 5 días",
        caseGain: "$63,000",
        userGain: "$45,000",
        plan: "galaxy" as const,
        planPrice: "$1,799", 
      ...
      "no_confianza_20_plus_clientes": {
        ...
        caseGoal: "25 clientes más/mes",
        caseResult: "35 clientes/mes en 5 días",
        caseGain: "$105,000",
        userGain: "$75,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "pierdo_competencia_5-10_clientes": {
        ...
        caseGoal: "8 clientes más/mes",
        caseResult: "12 clientes/mes en 3 días",
        caseGain: "$36,000",
        userGain: "$22,500",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "pierdo_competencia_10-20_clientes": {
        ...
        caseGoal: "15 clientes más/mes",
        caseResult: "19 clientes/mes en 3 días",
        caseGain: "$57,000",
        userGain: "$45,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "pierdo_competencia_20_plus_clientes": {
        ...
        caseGoal: "25 clientes más/mes",
        caseResult: "33 clientes/mes en 5 días",
        caseGain: "$99,000",
        userGain: "$75,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "no_tiempo_5-10_clientes": {
        ...
        caseGoal: "8 clientes más/mes",
        caseResult: "10 clientes/mes en 3 días",
        caseGain: "$30,000",
        userGain: "$22,500",
        plan: "rocket" as const,
        planPrice: "$999",
      ...
      "no_tiempo_10-20_clientes": {
        ...
        caseGoal: "15 clientes más/mes",
        caseResult: "17 clientes/mes en 5 días",
        caseGain: "$51,000",
        userGain: "$45,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
      ...
      "no_tiempo_20_plus_clientes": {
        ...
        caseGoal: "25 clientes más/mes",
        caseResult: "30 clientes/mes en 5 días",
        caseGain: "$90,000",
        userGain: "$75,000",
        plan: "galaxy" as const,
        planPrice: "$1,799",
