        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 mb-12">
          ...
          <div className="space-y-3 text-center lg:text-right">
            ...
            <div className="flex justify-center lg:justify-end space-x-3">
              ...
              <a 
                href="#" 
                className="w-8 h-8 bg-white/10 hover:bg-[#0147FF]/20 border border-white/20 hover:border-[#0147FF]/40 rounded-lg flex items-center justify-center transition-all duration-300"
              >
